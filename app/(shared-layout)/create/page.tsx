...
const Create = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0b] text-[#e8e6e1] font-sans relative overflow-hidden">
      {/* Background orbs */}
              ...
              <FieldGroup>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <Field data-invalid={fieldState.invalid}>
                        <FieldLabel htmlFor="imageCreditName" className="text-white/60">
                          Image Credit Name
                        </FieldLabel>
                        <Input
                          id="imageCreditName"
                  ...
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <Field data-invalid={fieldState.invalid}>
                        <FieldLabel htmlFor="imageCreditUrl" className="text-white/60">
                          Image Credit URL
                        </FieldLabel>
                        <Input
                          id="imageCreditUrl"
                          type="text"
                          placeholder="e.g. https://unsplash.com/... (Optional)"
                          aria-invalid={fieldState.invalid}
                          className="h-11 w-full rounded-md border border-white/10 bg-white/5 px-3 text-sm text-white placeholder:text-white/20 outline-none transition-colors focus-visible:border-violet-500/50"
                          {...field}
                        />
